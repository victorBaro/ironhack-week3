...
- (void) presentSubmenu {
    ...
    NSUInteger nIcons = [self.icons count];
    NSUInteger iconNumber = 0;
...
- (CGFloat) angleForIcon:(NSUInteger)iconNumber numberOfIcons:(NSUInteger)nIcons {
    CGFloat interSpace = 0.8; //Number of radians between 2 icons
    CGFloat totalAngle = (nIcons -1) * interSpace;
    CGFloat startAngle = self.direction - totalAngle/2;
