...
@interface VBFInteractiveTransition () <UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, UIViewControllerInteractiveTransitioning>
...
@implementation VBFInteractiveTransition
...
-(void)userDidPan:(UIScreenEdgePanGestureRecognizer *)recognizer {
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        if (location.x < CGRectGetMidX(recognizer.view.bounds)) {
            self.presenting = YES;
            SideMenuViewController *viewController = [[SideMenuViewController alloc] initWithPanTarget:self];
